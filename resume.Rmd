...
if(PDF_EXPORT){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/inanimate36/my_cv/raw/Non-website-version/Inan_Bostanci_CV.pdf)")
}
```
...
- <i class="fa fa-envelope"></i> ie.bostanci@gmail.com
